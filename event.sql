...
-- Dumping structure for table event.jnslomba
DROP TABLE IF EXISTS `jnslomba`;
CREATE TABLE IF NOT EXISTS `jnslomba` (
...
-- Dumping data for table event.jnslomba: ~0 rows (approximately)
DELETE FROM `jnslomba`;
